Note: this `README.md` file is preserved from the project template [TypeScript-Node-Starter](https://github.com/microsoft/TypeScript-Node-Starter). The information found here might not be up to date or accurately reflect the current state of the project.
